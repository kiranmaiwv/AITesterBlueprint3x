...
You are strictly forbidden from writing scripts in `tools/`  until:
    ...
    - The Data Schema is defined in [claude.md](https://claude.md/) 
...
**2. Data-First Rule:** You must define the **JSON Data Schema** (Input/Output shapes) in [claude.md.](https://claude.md/) Coding only begins once the "Payload" shape is confirmed.
...
**3. Documentation:** Finalize the **Maintenance Log** in `claude.md` for long-term stability.
