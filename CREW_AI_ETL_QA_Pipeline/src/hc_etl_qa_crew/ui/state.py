...
from hc_etl_qa_crew.models import RunSummary, StageEvent

RUN_KEY = "hc_run_summary"
RUNNING_KEY = "hc_run_in_progress"
PROGRESS_KEY = "hc_progress"
SETTINGS_KEY = "hc_settings"
ZIP_CACHE_KEY = "hc_zip_cache"
...
def record_progress(pipeline_name: str, event: StageEvent) -> None:
    progress: dict[str, dict[str, Any]] = st.session_state.setdefault(PROGRESS_KEY, {})
    progress.setdefault(pipeline_name, {})[event.stage.value] = {
